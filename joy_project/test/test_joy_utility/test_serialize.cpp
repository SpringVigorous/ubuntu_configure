...
public:
    ...
    {
        //x_object_flag_serialization_guard tmp_object_flag("Person", mt);

        int version = 1;

        mt & x_wrapper_macro_named(serialize_helper::pack_version("Person"),version);
...
{
public:
    Student(const string& name = "", int age = 0, const string& class_name = "") :Person(name, age), num_(class_name) {}
public:
    void serialize_members(member_rw_interface& mt)
    {

        //x_object_flag_serialization_guard tmp_object_flag("Student", mt);


        Person::serialize_members(mt);

        int version = 1;
        mt & x_wrapper_macro_named(serialize_helper::pack_version("Student"),version);
...
{
public:
    Techer(const string& name = "", int age = 0, const string& class_name = "") :Person(name, age), num_(class_name) {}
public:
    void serialize_members(member_rw_interface& mt)
    {
