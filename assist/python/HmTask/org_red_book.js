...
function calculateValue(B, mb) {
    return (
        -parseInt(B(0x1b2)) / 0x1 +
        parseInt(B(mb.A)) / 0x2 +
        parseInt(B(0x27b)) / 0x3 +
        -parseInt(B(0x1db)) / 0x4 +
        parseInt(B(mb.s)) / 0x5 +
        parseInt(B(0x268)) / 0x6 +
        parseInt(B(0x32d)) / 0x7 *
        (-parseInt(B(0x2d0)) / 0x8)
    );
}
// 假设 o 是一个返回数组的函数
function o() {
...
// 测试
console.log(B(0x18a + 1, null));  // 输出 'a'
console.log(B(0x18a + 2, null));  // 输出 'b'
console.log(B(0x18a + 3, null));  // 输出 'c'
console.log(B(0x18a + 4, null));  // 输出 'd'
(function() {
    var I7 = {
        A: 0x287,
        s: 0x1ae,
